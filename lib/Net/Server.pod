...
munin.  The version number (over 0.99) was chosen to imply IPv6
support and that it was the first such version.
...
I/we are sorry, but cannot we be counted on to do any further
development or support of Net::Server.  Whatever time we may or may
not have will go into munin.
